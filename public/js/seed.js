const seedData = [
{
	...
	rentalCost: 8,
	lateFee: 2,
	description: "This has nothing to do with curious George, just an old type of adjustable wrench with a straight handle and smooth jaws whose gripping faces are perpendicular to the handle.",
	url: 'https://images-na.ssl-images-amazon.com/images/I/6129PUdvZBL._SL1500_.jpg'
},{
	name: 'Chain Whip',
	type: 'Wrench',
	rentalCost: 6,
